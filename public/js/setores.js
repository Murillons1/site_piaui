...
var ctx = document.getElementById("grafico_setor3").getContext("2d");
var grafico_setor3 = new Chart(ctx, {
    type: 'pie',
    data: dados,
    options: opcoes
});
...
var ctx = document.getElementById("grafico_setor5").getContext("2d");
var grafico_setor5 = new Chart(ctx, {
    type: 'pie',
    data: dados,
    options: opcoes
});
...
var ctx = document.getElementById("grafico_setor7").getContext("2d");
var grafico_setor7 = new Chart(ctx, {
    type: 'pie',
    data: dados,
    options: opcoes
});
...
var ctx = document.getElementById("grafico_setor9").getContext("2d");
var grafico_setor9 = new Chart(ctx, {
    type: 'pie',
    data: dados,
    options: opcoes
});
...
var ctx = document.getElementById("grafico_setor11").getContext("2d");
var grafico_setor11 = new Chart(ctx, {
    type: 'pie',
    data: dados,
    options: opcoes
});